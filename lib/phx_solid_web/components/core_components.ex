defmodule PhxSolidWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxSolidWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxSolidWeb.Gettext, "errors", msg, opts)
    end
  end
